...
void add_user(char *username, char *password, char *role, int fd, struct sockaddr_in client_address, socklen_t client_address_len);
// DEL <username>
void remove_user(char *username, int fd, struct sockaddr_in client_address, socklen_t client_address_len);
// LIST
void list_users(int fd, struct sockaddr_in client_address, socklen_t client_address_len);
// QUIT_SERVER
